...
singularity exec --bind "${PWD}:/mnt" --nv ../hyperview_latest.sif python main_hyper_view_training.py -m 0 -c 5 -l 0.1000 -b 16 -w 224 --num-epochs 99 -p --in-data "$(pwd)/train_data" --save-model
